...
public class PacienteEditarWindow extends JFrame {
	...
	public PacienteEditarWindow(PacienteWindow pacienteWindow, String nome, String telefone, String dataNascimento, String bairro, String logradouro, String estado, String numeroCasa, String cidade, boolean sexo) {
		...
		this.formattedText_Telefone.setText(telefone);
		this.formattedText_Data.setText(dataNascimento);
		this.textBairro.setText(bairro);
		this.textLogradouro.setText(logradouro);
		this.textEstado.setText(estado);
		this.textNumeroCasa.setText(numeroCasa);
		this.textCidade.setText(cidade);
	...
	public void initComponents() {
		...
		btnCadastrar = new JButton("Confirmar e Salvar");
		...
		btnCancelar.setBounds(294, 441, 189, 39);
